...
function DynamicDarkSettings() {
  ...
  return (
    <div className="DynamicThemeDark" 
      css={css`
        background: #222; 
        padding: 5px; 
        border-radius: 2px;
        ...
        <div style={{display: 'flex', justifyContent: 'space-between', height: '21px'}}>
          <label htmlFor="lightnessSettingNavBar">TopBar:</label>
            <div style={{display: 'flex', alignContent: 'center', alignItems: 'center'}}>
              ...
              <input type="number" min="0" max="30" name="lightnessSettingNavBar" value={dynamicDarkPrefs.lightnessSettingNavBar} onChange={handleChange} style={{width: '40px', backgroundColor: 'inherit', border: 0, borderBottom: '1px solid black', color: 'white', marginLeft: '8px'}} />
            </div>
        </div>
        <div style={{display: 'flex', justifyContent: 'space-between', height: '21px'}}>
          ...
          <div style={{display: 'flex', alignContent: 'center', alignItems: 'center'}}>
            ...
            <input type="number" min="0" max="30" name="lightnessSettingPlayPage" value={dynamicDarkPrefs.lightnessSettingPlayPage} onChange={handleChange} style={{width: '40px', backgroundColor: 'inherit', border: 0, borderBottom: '1px solid black', color: 'white', marginLeft: '8px'}} />
          </div>
        </div>
        <div style={{display: 'flex', justifyContent: 'space-between', height: '21px'}}>
          ...
          <div style={{display: 'flex', alignContent: 'center', alignItems: 'center'}}>
            ...
            <input type="number" min="0" max="30" name="lightnessSettingPlayerBar" value={dynamicDarkPrefs.lightnessSettingPlayerBar} onChange={handleChange} style={{width: '40px', backgroundColor: 'inherit', border: 0, borderBottom: '1px solid black', color: 'white', marginLeft: '8px'}} />
          </div>
        </div>
        <div style={{display: 'flex', justifyContent: 'space-between', height: '21px'}}>
          ...
          <div style={{display: 'flex', alignContent: 'center', alignItems: 'center'}}>
            ...
            <input type="number" min="0" max="30" name="lightnessSettingBody" value={dynamicDarkPrefs.lightnessSettingBody} onChange={handleChange} style={{width: '40px', backgroundColor: 'inherit', border: 0, borderBottom: '1px solid black', color: 'white', marginLeft: '8px'}} />
          </div>
        </div>
        <div style={{display: 'flex', justifyContent: 'space-between', height: '21px'}}>
          ...
          <div style={{display: 'flex', alignContent: 'center', alignItems: 'center'}}>
            ...
            <input type="number" min="0.5" max="1" name="saturationSetting" value={dynamicDarkPrefs.saturationSetting} step="0.1" onChange={handleChange} style={{width: '40px', backgroundColor: 'inherit', border: 0, borderBottom: '1px solid black', color: 'white', marginLeft: '8px'}} />
          </div>
        </div>
      </form>
    </div>
