function YtmIcon({ circleColor, textColor, stroke, partial, full, ...props }) {
  return (
    <div id="ThemeSong-YtmIcon">
      <style>
        {`
          :root {
      ...
      {partial && (
        ...
        >
          ...
          <ellipse
            ...
            strokeWidth="1.2"
          />
          <path d="M16 12L9.775 15.4641L9.775 8.5359L16 12Z" fill={stroke || "#fff"} />
        </svg>
      )}
      {full && (
